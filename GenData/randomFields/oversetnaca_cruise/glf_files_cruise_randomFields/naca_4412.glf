...
set _TMP(mode_1) [pw::Application begin CaeExport [pw::Entity sort [list $_BL(1) $_DM(1) $_DM(5) $_DM(6) $_DM(4) $_DM(7) $_DM(2) $_DM(3)]]]
  ##$_TMP(mode_1) initialize -strict -type CAE {./data/naca/naca_4412_1.0/}
  $_TMP(mode_1) initialize -strict -type CAE {./data/naca/naca_4412/}
  $_TMP(mode_1) verify
  $_TMP(mode_1) write
$_TMP(mode_1) end
unset _TMP(mode_1)
...
cleanGrid
airfoilMesh
##pw::Application save  "./data/pw/naca_4412_1.0.pw"
pw::Application save  "./data/pw/naca_4412.pw"
pw::Application exit
